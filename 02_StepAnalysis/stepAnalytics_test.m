...
% suffix _c1. 
subj_test_off = {'013.1', '014.1', '015.1', '017.1', '020.1', '021.1'}; 
subj_test_on = {'013.2', '014.2', '015.2', '016.2'}; 
...
matDir = '/Subj_Preprocessed_Data/'; 
csvDir = '/Skeleton_Coords/'; 
...
figure(1); 
hold on; 
plot(Subj_020_1_Step.step); 
plot(Subj_020_1_Step.loc, Subj_020_1_Step.step(Subj_020_1_Step.loc), ...
    'd', 'MarkerFaceColor', 'g');
yLims = get(gca, 'YLim');
for iii=1:length(Subj_020_1_Step.samples)
    line(Subj_020_1_Step.samples(iii)*ones(1, 2), yLims, 'Color', 'r'); 
end
title('Subject 20-ON');
